...
const CoinField = ({ coin, value }) => {
  return (
    <div className='w-full px-4 py-4 flex flex-col'>
        <div className='flex space-x-2 items-center mb-2 cursor-pointer hover:opacity-80'>
        ...
        <div className='w-full h-14 p-4 flex justify-end bg-purple-200 rounded-xl'>
            <input value={ value } className='w-full text-purple-400 font-bold bg-transparent outline-none text-right' type="text"/>
        </div>
    </div>
  )
}
